...
/*
Time Complexity: O(nW), where 'n' is the number of items and
 'W' is the capacity of the knapsack.

Space Complexity: O(nW) 
 It is determined by the size of the table used for dynamic programming,
 which is (n+1) x (W+1), where 'n' is the number of items and 'W' is 
