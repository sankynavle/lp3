...
/*
Time Complexity: O(N!) 
where 'N' is the number of queens to be placed on an N x N chessboard.

Auxiliary Space: O(N^2)
The space complexity is O(N), representing the space used for the 
chessboard and the recursion stack during the backtracking process.
*/
